...
/**
 * Created by new_user on 17/12/2016.
 */
...
public class AlunoDAO extends SQLiteOpenHelper {
    ...
    public void onCreate (SQLiteDatabase db) {
        String sql = "CREATE TABLE Alunos (id CHAR(50) PRIMARY KEY," +
                " nome TEXT NOT NULL," +
                " endereco TEXT," +
                " telefone TEXT," +
                " site TEXT," +
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int i1) {
        ...
        switch (oldVersion){
            ...
            case 2:
                ...
                String removendoTabelaAntiga = "DROP TABLE IF EXISTS Alunos";
    ...
    public void insere(Aluno aluno){
        ...
        ContentValues values = getDadosAlunos(aluno);
    ...
    private boolean existe(Aluno aluno) {
        ...
        Cursor cursor = database.rawQuery(existe, new String[]{aluno.getId()});
    ...
    @NonNull
    private ContentValues getDadosAlunos(Aluno aluno) {
